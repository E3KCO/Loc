...
class AccountAnalyticLine(models.Model):
    ...
    #     if analytic_line['project_id'] and analytic_line.is_billable:
    #         project = self.env['project.project'].browse(analytic_line['project_id'])
    #         analytic_line['is_billable'] = analytic_line['project_id'].allow_billable
    #
    ...
    def _onchange_task_id(self):
        if self.task_id:
            self.name = self.task_id.automatic_description or self.name
